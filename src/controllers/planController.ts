...
export const getPlanHistory = async (req: Request, res: Response) => {
    try {
        // TODO: Implementar historial de planes
        res.json({
...
export const getBeginSteps = async (req: Request, res: Response) => {
  try {
...
export const getPlanSteps = async (req: Request, res: Response) => {
  try {
...
export const determineRecommendedPlan = async (req: Request, res: Response) => {
  try {
